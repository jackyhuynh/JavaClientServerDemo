...
public class Util {
	...
	Scanner in = new Scanner(System.in);
		...
		/* 		# MainReadInput(filename : String ) : void
	 	 * 
	 	 * Logic:	Manipulate All the Read input method 
	 	 *Read the first three line and allocate the new Automotive Object
	 	 * 
		----------------------------------------------------------------*/
         public LinkedHashMap<String, Automobile> _Build_Auto_(String filename)
         {
            ...
            return Set_Of_User_ChoiceHashMap;
                ...
                //_Build_Auto_Manager:
		protected Automobile _Build_Auto_Manager(
	 ...
	 -----------------------------------------------------------------------*/
		...
		protected void ControlManager(Automobile AutoNew)
		{
			...
			StringBuffer Choice= new StringBuffer("\nFirst Enter "
                                + "Your Choice '1' too start the program: ");
			...
			switch(choice)  {
				case 1:	ControlOptionSetArray(); break;
					
				case 2:	ControlOptionArray();    break;
					
				case 3: AutoNew.PrintDisplayList();break;
		...
		protected void ControlOptionArray(){
			...
			switch(choice)
			{
			case 1:		Increase_Option();	break;
			
			case 2:		Update_A_Option();	break;
			
			case 3:		Delete_A_Option();	break;
		...
		{
			System.out.print(Auto.Print_Text_OptionSet_Menu(
                                INCREASE_A_OPTION));
		...
		protected void Delete_A_Option()
		{
			...
			System.out.print(
                                Auto.Print_Text_OptionSet_Menu(DELETE_A_OPTION));
			
			System.out.print(DECISION);	
                        Choice=Validation((Auto.getMaxIndex()+1),1);
			
			System.out.print(
                                Auto.SearchAndPrintManager(Choice));
		...
		* 
		...
		protected int Validation(int Max, int Min )
		{
			...
			StringBuffer Error= new StringBuffer(
                                "\n\tSorry you are enter invalid number,"
                                        + "Please enter again!");
			Error.append("\n\tValid Number should be smaller than ")
                                .append(Max).append(" and bigger than ")
                                .append(Min).append(": ");
		...
		{ 
			try{    
                            try (ObjectOutputStream out = new ObjectOutputStream(
                                    new FileOutputStream("NewInput.dat"))) {
		...
		{ 
			...
			try{
                            try (ObjectInputStream in = new ObjectInputStream(
                                    new FileInputStream("NewInput.dat"))) {
