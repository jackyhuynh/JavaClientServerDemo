...
public class ReadTextFile {//1s
	...
	final String UPDATE_A_OPTION    = "UPDATE A OPTION";
        ...
        //This method read and create the Automobile Object from the properties file
	public Automobile buildObjectProperties(Properties props) throws IOException{
		...
		if (!(carModel == null)){
			...
			Automobile auto1;
                    auto1 = new Automobile(    props.getProperty("CarMake").toUpperCase()   
			...
			{   
                            ...
                            auto1.setoptset(props.getProperty(Optionset).toUpperCase());//Create a Set of OptionSet
				...
				auto1.setOption(auto1.getOptSet(i), props.getProperty(optionvalue).toUpperCase(),Float.parseFloat(props.getProperty(optionvalue+"p")));
			     }
			}
			return auto1;
		}
