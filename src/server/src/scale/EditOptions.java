...
public class EditOptions extends Thread {
    ...
    /**
     *   EditOptions 
     * OptionName : indicate what Operation is given 
     * automobile : Automobile to modify
     * Model      : What Model is this
     * OptionName : depend on the integer operation the OptionName 
     ...
     * 
     */
public EditOptions(Automobile NewAuto, int Operation, String ModelName,
        String OptionName ) {
     ...
     *      +   OptionSet_Edit_Manager(Operation : int , ModelName :String 
     *                                           , Name : String ): void
     *      To edit ...
     */
    @Override
	 ...
	 synchronized(automobile) {
        ...
        *                                           , Name : String ): void
        *
        *   +   Receive the Operation : int to decide what moficatiuon will 
        *   happen Using the same parameter field for increase , update and delete
        *   +   Call Process():void function to do st with the thread in this case   
        *   just call the Thread to sleep and also show how many thread is active
        *   and what thread is in active
...
{  
    switch (Operation) {
        ...
        *       Call Process():void function to do st with the thread in this case   
        *   just call the Thread to sleep and also show how many thread is active
        *   and what thread is in current active
        *       catch InterruptedException...
        *
        */
public void Process() {
            try {
                System.out.println("Total Threads active is: "
                        + Thread.activeCount());
                System.out.println("Thread in process is: "
                         +Thread.currentThread()+" is in process");
         ...
         *      
         * Simple Call:
         *       Automobile::DeleteManager(ModelName: String , Name : String)
         *          to delete a OptionSet with given Name
         * 
         */
public void Delete_A_OptionSet(String ModelName, String Name)
{
	...
	automobile.DeleteManager(ModelName,Name);
         ...
         *      
         * Simple Call:
         *       Automobile::UpdateManager(ModelName: String , Name : String)
         *          to increase a OptionSet with new Name
         * 
         */
public void Increase_A_OptionSet(String ModelName, String New_Name)
{
	...
	automobile.UpdateManager(ModelName, New_Name);
         ...
         *      
         * Simple Call:
         *       Automobile::SearchAndPrintManager(Option_Name : String)
         *          to print a set of Options 
         * 
         */
